...
class CNN3D(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose3d(in_channels=128,out_channels=128,kernel_size=(2,3,3),stride=(2,2,2),padding=1,output_padding=1)
        self.deconv2 = nn.ConvTranspose3d(in_channels=128,out_channels=64,kernel_size=(2,4,4),stride=(1,2,2),padding=1,output_padding=0)
